...
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/contractiles"]
...
This repository was scaffolded from the *Rhodium Standard Repository (RSR)*
template, so it also ships with CI/CD, machine-readable project metadata, an
...
* *Supply-chain & reproducibility* — container layering (stapeln), Guix/Guix shells,
