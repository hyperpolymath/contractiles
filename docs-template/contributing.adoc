...
= Contributing — Contractiles
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Contractiles`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Contractiles.git
cd Contractiles
...
* Bugs in `Contractiles`: file at `hyperpolymath/Contractiles/issues`.
