...
// Template: contractiles/docs/status/PROOF-NEEDS.adoc
// Authoritative master list: ~/Desktop/PROOF-REQUIREMENTS-MASTER.adoc
= Proof Requirements — CONTRACTILES
...
These proofs come from the contractiles and MUST be present in every repo:
